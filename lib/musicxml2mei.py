...
xml_path = Path("test_scores/musicxml/polyphonic_score_2b.xml")
mei_path = Path("test_scores/polyphonic_score_2b.mei")
musicxml2mei(xml_path, mei_path)

xml_path = Path("test_scores/musicxml/polyphonic_score_2a.xml")
mei_path = Path("test_scores/polyphonic_score_2a.mei")
musicxml2mei(xml_path, mei_path)
